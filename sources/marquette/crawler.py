#!/usr/bin/env python3
"""
Marquette University 爬虫
从 https://today.marquette.edu/archive/ 抓取最新新闻
只抓取最近4天内的文章
"""
import json
import requests
...
MARQUETTE_URL = "https://today.marquette.edu/archive/"
RAW_DIR = "data/raw/marquette"
...
def categorize(title):
    ...
    categories = {
        'financial_aid': ['student aid', 'financial aid', 'federal', 'fsa'],
        'campus': ['campus', 'information session', 'event'],
        'graduate': ['graduate', 'grad'],
        'advising': ['adviser', 'advisor', 'counseling']
    }
...
def crawl_marquette():
    """从 Marquette University 抓取最新新闻（最近4天）"""
    print("🚀 开始抓取 Marquette University...")
    print(f"📡 网址: {MARQUETTE_URL}")
    print(f"📅 只抓取最近4天内的文章")
    ...
    try:
        ...
        response = requests.get(MARQUETTE_URL, headers=headers, timeout=20)

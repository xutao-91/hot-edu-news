#!/usr/bin/env python3
"""
UW-Madison Graduate School 爬虫
从 https://grad.wisc.edu/category/news/ 抓取最新新闻
只抓取最近4天内的文章
"""
import json
import requests
...
UW_GRAD_URL = "https://grad.wisc.edu/category/news/"
RAW_DIR = "data/raw/uw_gradschool"
...
def crawl_uw_gradschool():
    """从 UW-Madison Graduate School 抓取最新新闻（最近4天）"""
    print("🚀 开始抓取 UW-Madison Graduate School...")
    print(f"📡 网址: {UW_GRAD_URL}")
    print(f"📅 只抓取最近4天内的文章")
    ...
    try:
        ...
        response = requests.get(UW_GRAD_URL, headers=headers, timeout=20)
            ...
            try:
                ...
                if title and url:
                    articles.append({
                        ...
                        'source': 'UW-Madison Graduate School',

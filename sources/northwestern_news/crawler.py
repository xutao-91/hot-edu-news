#!/usr/bin/env python3
"""
Northwestern University News 爬虫
从 https://news.northwestern.edu/university-news 抓取最新新闻
只抓取最近4天内的文章
"""
import json
import requests
...
NORTHWESTERN_URL = "https://news.northwestern.edu/university-news"
RAW_DIR = "data/raw/northwestern_news"
...
def categorize(title):
    ...
    categories = {
        'awards': ['honors', 'fellow', 'award', 'elected'],
        'research': ['research', 'researchers', 'study'],
...
def crawl_northwestern():
    """从 Northwestern News 抓取最新新闻（最近4天）"""
    print("🚀 开始抓取 Northwestern University News...")
    print(f"📡 网址: {NORTHWESTERN_URL}")
    print(f"📅 只抓取最近4天内的文章")
    ...
    try:
        ...
        response = requests.get(NORTHWESTERN_URL, headers=headers, timeout=20)
        ...
        for item in article_items:
            try:
                ...
                if href.startswith('http'):
                    ...
                    url = f"https://news.northwestern.edu{href}"

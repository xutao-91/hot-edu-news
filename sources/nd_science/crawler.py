#!/usr/bin/env python3
"""
Notre Dame College of Science 爬虫
从 https://science.nd.edu/news-and-media/news/ 抓取最新新闻
只抓取最近4天内的文章
"""
import json
import requests
...
ND_SCIENCE_URL = "https://science.nd.edu/news-and-media/news/"
RAW_DIR = "data/raw/nd_science"
...
def categorize(title):
    ...
    categories = {
        'health': ['health', 'medical', 'community health'],
        'student': ['student', 'senior', 'commitment'],
        'science': ['science', 'research', 'academic'],
        'service': ['community', 'service', 'project']
    }
...
def crawl_nd_science():
    """从 Notre Dame College of Science 抓取最新新闻（最近4天）"""
    print("🚀 开始抓取 Notre Dame College of Science...")
    print(f"📡 网址: {ND_SCIENCE_URL}")
    print(f"📅 只抓取最近4天内的文章")
    ...
    try:
        ...
        response = requests.get(ND_SCIENCE_URL, headers=headers, timeout=20)
        ...
        for item in article_items:
            try:
                ...
                if href.startswith('http'):
                    ...
                    url = f"https://science.nd.edu{href}"
                ...
                if title and url:
                    articles.append({
                        ...
                        'type': 'News',
                        'summary_en': '',  # 列表页无摘要
                        'source': 'Notre Dame College of Science',

...
translations_db = {
    ...
    "pewresearch": {
        ...
        "Key facts about same-sex marriage around the world, 25 years after the Netherlands legalized it": {
            ...
            "summary_cn": "皮尤研究中心发布调查报告，回顾荷兰成为全球首个全国性立法承认同性婚姻国家25周年以来的全球立法进展。调查数据显示，截至目前已有近40个国家和地区通过立法承认同性婚姻合法地位，但各国普及程度和公众接受度差异显著。报告深入分析了不同地区在婚姻平权方面的政策取向、立法进程和社会接受度演变。"
        },
        "Americans Broadly Disapprove of U.S. Military Action in Iran": {
            "title_cn": "美国人普遍不赞成美国对伊朗采取军事行动",
            "summary_cn": "皮尤研究中心最新民调显示，多数美国民众认为对伊朗采取军事行动是错误决定，并对特朗普政府处理中东冲突的方式表示不满。调查显示，在此议题上党派分歧明显，民主党与共和党支持者立场差异悬殊。民调还发现，年轻群体和受过高等教育的受访者更倾向于反对军事干预，而年长群体则相对支持强硬政策。"
        },
        "The United States at 250: How the Country Has Changed in the Past 50 Years": {
            "title_cn": "建国250周年的美国：过去50年国家的变化",
            "summary_cn": "皮尤研究中心发布大型数据专题报告，基于美国人口普查局50年来的权威数据，系统梳理1976年以来美国社会在人口结构、劳动力市场、家庭形态和经济状况等方面的深刻变化。报告指出，美国正经历人口老龄化加速、家庭结构多元化、收入差距持续扩大、种族构成深刻变化等重大社会转型。"
        },

...
translations_db = {
    ...
    "purdue": {
        ...
        "CHL's 'Full Plate Living' series helps transform eating habits": {
            "title_cn": "CHL'满盘生活'系列帮助改变饮食习惯",
            "summary_cn": "普渡大学消费者健康实验室（Consumer Health Lab, CHL）推出的'满盘 Living'系列项目帮助参与者改变饮食习惯，促进更健康的生活方式。该项目通过教育讲座、实践工作坊、个性化指导等方式，帮助参与者了解营养知识、制定健康饮食计划、建立可持续的饮食习惯。项目强调均衡饮食、适量摄入、食物多样性等原则，而非极端节食。参与者反馈显示，该项目在帮助人们改善饮食行为、增强健康意识、提升生活质量方面取得了积极成效。"
        },

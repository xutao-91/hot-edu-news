...
translations_db = {
    ...
    "edgov": {
        ...
        "U.S. Department of Education Announces Next Steps for Borrowers Enrolled in the Unlawful SAVE Plan": {
            ...
            "summary_cn": "美国教育部宣布针对参与被法院裁定非法的SAVE（学生贷款还款）计划借款人的后续措施。此前，SAVE计划因法律挑战被法院裁定超越教育部法定权限。教育部表示将依法处理相关贷款，在确保借款人权益的同时遵守法院判决。对于已参与SAVE计划的借款人，教育部将提供过渡期安排，包括恢复到之前的还款计划选项、提供还款计划转换指导、确保借款人在转换过程中不会受到惩罚性措施影响。教育部还将通过官方网站和客户服务渠道向受影响借款人提供详细信息，帮助他们了解可选的替代还款方案，包括标准还款计划、收入驱动还款计划等其他联邦学生贷款还款选项。"
        },
        "Victories for Higher Education: Raising Academic Standards and Ensuring Admissions Transparency": {
            ...
            "summary_cn": "美国教育部发布高等教育政策成果报告，强调提高学术标准和确保招生透明度的重要性。报告指出，近期实施的政策改革旨在维护高等教育质量，为学生提供公平竞争环境，并确保高等教育机构对其招生决策负责。具体措施包括加强对高校招生流程的监督、要求更详细的招生数据披露、以及推动标准化测试在招生决策中的合理使用。教育部认为，这些举措有助于恢复公众对高等教育招生公平性的信心，确保所有合格学生不论背景如何都能获得公平的入学机会。报告还强调了维护学术严谨性的重要性，反对为追求多样性而降低学术标准，主张通过提升教育质量而非降低门槛来实现教育公平。"
        }
    },
    "whitehouse": {
        ...
        "New White House App Delivers Unparalleled Access to the Trump Administration": {
            ...
            "summary_cn": "白宫宣布推出新的官方应用程序，为公众提供前所未有的获取特朗普政府资讯的渠道。该应用程序将实时发布总统声明、政策更新、行政命令签署、白宫活动日程安排以及其他重要政府信息。用户可以通过应用接收推送通知，第一时间了解政府重大决策和政策变化。此外，应用还提供总统演讲视频、白宫新闻发布会直播、以及政府各部门发布的官方报告和数据。白宫表示，这一数字平台的推出旨在加强与公众的直接沟通，绕过传统媒体过滤，让美国民众能够直接从政府获取未经编辑的第一手信息。应用还提供与白宫互动的功能，包括政策反馈渠道和活动参与机会，体现了特朗普政府重视公民参与和透明度的承诺。"
        },
    ...
    "ace": {
        ...
        "Court Order Delaying ACTS Deadline Applies Only to Public Institutions in 17 States": {
            ...
            "summary_cn": "美国教育委员会（ACE）就法院推迟ACTS（招生与消费者透明度补充调查）截止日期的命令发布说明。ACE指出，该法院命令仅适用于17个州的公立高等院校，其他地区的高等教育机构仍需按原计划执行ACTS要求。ACTS是教育部IPEDS系统的补充调查，旨在收集更详细的招生和消费者透明度数据。法院此次限制性的裁决反映了法律挑战的复杂性，以及联邦教育数据收集政策在不同州面临的差异化执行环境。ACE建议各院校密切关注本州法律动态，确保合规操作。"
        }
    },
    "nsf_ncses": {},
    "pewresearch": {
        "Many Latin Americans – especially Protestants – see a role for religion in national leadership, identity and laws": {
            ...
            "summary_cn": "皮尤研究中心在拉丁美洲进行的一项全面调查显示，许多拉丁美洲人，特别是新教徒，认为宗教应在国家领导、身份认同和法律制定中发挥重要作用。在巴西、哥伦比亚和秘鲁等主要国家，大多数受访民众希望国家领导人能够捍卫其宗教信仰，并将宗教价值观融入国家政策。新教徒群体尤其支持基督教在公共生活中发挥更大影响力，包括在教育政策、家庭法律和社会道德规范制定方面。调查还揭示了不同宗教群体、年龄段和教育背景人群对政教关系的看法差异。这些发现对理解拉丁美洲地区的政治生态、宗教政治化趋势以及民主制度的演变具有重要意义，也为分析美国与该地区的外交关系提供了有价值的背景信息。"
        },
        "Religious Radio Across America": {
            "title_cn": "美国宗教广播",
            "summary_cn": "皮尤研究中心的一项全面分析显示，几乎所有美国成年人都处于宗教广播电台的覆盖范围内，其中最常见的是基督教广播电台。这些电台通常主要播放宗教音乐或福音谈话节目，为听众提供宗教内容、社区信息和灵修资源。研究发现，宗教广播在美国农村地区和中西部尤其普及，成为许多居民获取信息、娱乐和精神支持的重要渠道。这一媒介在维护宗教社区凝聚力、传播保守价值观以及连接分散的信徒群体方面发挥着不可替代的作用，是美国宗教生态系统和保守派政治动员中不可忽视的组成部分。研究还揭示了宗教广播听众的人口特征、收听习惯及其对公共舆论形成的影响。"
        },
    ...
    "rand": {
        "Standards-Aligned Instructional Materials Use and Science Practices in K–12 Schools: Findings from the Spring 2025 American Instructional Resources Survey": {
            ...
            "summary_cn": "兰德公司发布基于2025年春季美国教学资源调查的重要研究报告，深入分析幼儿园至12年级科学教师使用符合课程标准的教学材料的情况。研究揭示了当前科学教育领域在采用和实施符合国家标准教学材料方面的现状、挑战和机遇。报告发现，尽管课程标准已明确，但许多学校在实际教学中仍面临教学材料选择困难、教师培训不足、资源配置不均等问题。研究强调了采用高质量、符合标准的教学材料对提升学生科学素养的关键作用，并提出了改善教学材料使用、加强教师专业发展、优化资源配置的政策建议。这些发现对推动美国K-12科学教育改革、提升STEM教育质量具有重要参考价值。"
        },
        "Implications of Chinese Influence Operations for South Korea and the US-ROK Alliance": {
            "title_cn": "中国影响力行动对韩国及美韩联盟的影响",
            "summary_cn": "兰德公司研究报告深入分析中国影响力行动对韩国及美韩联盟的战略影响。研究指出，中国通过经济、文化、网络等多种渠道在韩国开展影响力行动，旨在削弱美韩联盟凝聚力、塑造有利于中国的地区舆论环境、并在关键问题上影响韩国政策取向。这些行动包括利用经济依赖关系施加政治压力、通过文化交流项目传播亲华叙事、以及在社交媒体上开展信息战。报告评估了这些影响力行动对美韩联盟安全的潜在威胁，分析了韩国社会各界对中国影响力的不同反应，并为美韩两国政府提出了加强联盟韧性、应对外部影响力挑战的政策建议。研究对理解亚太地区地缘政治竞争、维护美国同盟体系具有重要意义。"
        },
        "Open Models, Soft Power, and the Spectrum of U.S.-China Artificial Intelligence Competition": {
            "title_cn": "开放模型、软实力与美人工智能竞争谱系",
            "summary_cn": "兰德公司专家洞见文章深入探讨开放AI模型、软实力在美中人工智能竞争中的复杂作用。研究分析了开源与闭源AI模型发展的不同路径及其对全球AI生态的影响，指出开放模型在加速技术传播、促进国际研究合作方面的优势，以及在安全管控和防止恶意使用方面面临的挑战。文章还讨论了软实力在AI竞争中的重要性，包括技术标准制定、国际规则塑造、以及全球人才吸引等方面。研究认为，美中AI竞争不仅是技术能力的较量，更是发展模式、价值观和国际影响力的全面竞争。报告为美国制定AI战略、平衡创新与安全、维护技术领导地位提供了政策参考。"
        },

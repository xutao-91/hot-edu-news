...
translations_db = {
    ...
    "heritage": {
        ...
        "Refuting False Claims of Fraud in Arizona’s School Choice Program": {
            "title_cn": "驳斥亚利桑那州学校选择项目中的欺诈虚假指控",
            "summary_cn": "传统基金会发表评论，驳斥针对亚利桑那州学校选择项目的欺诈指控。文章指出这些指控缺乏事实依据，学校选择项目实际上为学生和家庭提供了更多教育机会。"
        }
    }
}
...
def main():
    ...
    sources = ['brookings', 'edgov', 'whitehouse', 'ace', 'nsf_ncses', 'pewresearch', 'heritage']

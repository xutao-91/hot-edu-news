...
# 6. 运行Heritage爬虫
echo ""
echo "📰 [6/25] 运行 Heritage Foundation 爬虫..."
...
# 7. 运行Rand爬虫
echo ""
echo "📰 [7/25] 运行 Rand Corporation 爬虫..."
